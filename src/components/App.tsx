...
import * as CheckboxItemsJson from './tests/__mocks__/CheckboxItems.json';
import * as CheckboxSelectedItemsJson from './tests/__mocks__/CheckboxSelectedItems.json';
